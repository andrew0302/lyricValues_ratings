...
RMSEA <= .06 and SRMSR <= .08 suggest good fit. This model has poor fit

```{r}
#estimate model
mod <- (mirt(lyrics_preferences_dt, 1, verbose = FALSE, itemtype = 'graded', SE = TRUE))
...
This suggests that our scale was better at measuring low occurences of the trait, rather than high occurences. 
