...
```{r}
#t <- gather_summarized_machine_runs(list_of_machine_data_tables, file_names, setup_names)
```



```{r}
organize_machine_outputs_as_subjects <- function(data_files){
...
#t <- organize_machine_outputs_as_subjects(data_files)
```